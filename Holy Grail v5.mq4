...
input string   inpTradeComments  =  "Holy Grail v4";  //Trade comment
...
double MAStop= iMA(Symbol(),Period(),30,0,MODE_EMA,PRICE_MEDIAN,1);
...
if (OrderCloseTime()==0)
 ...
 ////----------------------------------------------------------------------------------------------------- MAIN PROGRAM PART
   ...
   double EMA= iMA(Symbol(),Period(),30,0,MODE_EMA,PRICE_CLOSE,1);  
