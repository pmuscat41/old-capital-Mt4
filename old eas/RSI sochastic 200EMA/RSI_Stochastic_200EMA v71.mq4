...
//
//
// v70 - no direction for trades- optimized results with various parameters, eg. Rsi 14

/// XL - long trade conditions
/// XS = short trade conditions
...
input string   inpTradeComments  =  "RSI STOCHASTIC 200 V70";  //Trade comment
...
Docket= CheckLongTrade (higherHigh,lowerLow,multiplier,XmarketTurnCounter);}
 ...
 /////-------------------------------------------------------------------------------------------------------------------------------------
 if (   (stomain>stosig)&& (marketTurnCounter< inpMarketTurnCounter)) 
 ...
 
 {
        ...
        double stosig=iStochastic(Symbol(),Period(),3,3,14,MODE_SMA,0,MODE_SIGNAL,1);
          ...
          if ( (stomain>stosig) && (XmarketTurnCounter< inpMarketTurnCounter)) 
                 {
...
//+------------------------------------------------------------------+    
 /// shortTrade conditions XS
  ...
  double Shorttop= iMA(Symbol(),PERIOD_D1,50,0,MODE_EMA,PRICE_HIGH,1);
...
//// long trade conditions XL  
  ...
  double twohundrMA=iMA(Symbol(),Period(),200,0,MODE_EMA,PRICE_CLOSE,1);
  double Longtop= iMA(Symbol(),PERIOD_D1,50,0,MODE_EMA,PRICE_LOW,1);
