...
input double inpStoploss= 0.002;// input stoploss
...
//  Trade entry
      ...
      if ((ADXnow>inpADXTrigger)&& (ticket==0)&&(iRSI(NULL,NULL,30,PRICE_CLOSE,1) >70))  {
      ticket   =  orderOpen(ORDER_TYPE_BUY, inpStoploss,0);
      
      }else
      if ((ADXnow>inpADXTrigger)&&(ticket==0)&&(iRSI(NULL,NULL,30,PRICE_CLOSE,1) <30)) {
