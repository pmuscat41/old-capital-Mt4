...
double MA9= iMA (Symbol(),Period(),9,0,MODE_EMA,PRICE_CLOSE,0);
double MA30= iMA (Symbol(),Period(),30,0,MODE_LWMA,PRICE_CLOSE,0);
         ...
         if (OrderType()==ORDER_TYPE_BUY)
            if (Bid <MA30)
               ...
               while (GetLastError()!=0)
                  ...
                  {Sleep(25); RefreshRates(); OrderClose(ticket,OrderLots(),Bid,10,clrAntiqueWhite);}
         ...
         if (OrderType()==ORDER_TYPE_SELL);
            if (Ask>MA30)
               ...
               while (GetLastError()!=0)
                  ...
                  {Sleep(25); RefreshRates(); OrderClose(ticket,OrderLots(),Ask,10,clrAntiqueWhite);}
